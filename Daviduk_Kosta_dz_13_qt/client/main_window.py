...
class ClientMainWindow(QMainWindow):
    def __init__(self, database_client, recept_transport, send_transport, login):
        super().__init__()
        # основные переменные
        ...
        self.chat = MainChat(self.send)

        # Обработчик сигнала, связанного с объектом
        self.recept.new_message.connect(self.chat.history_list_update)
